export default class Bootloader extends Phaser.Scene {
    ...
    preload () {
        ...
        this.load.bitmapFont("rustler", "assets/fonts/rustler.png", "assets/fonts/rustler.xml");
        ...
        this.load.image('css', 'assets/images/css3.png');
        this.load.image('js', 'assets/images/js.png');
        this.load.image('python', 'assets/images/python.png');
        ...
        this.load.bitmapFont("3d", "assets/fonts/3d.png", "assets/fonts/3d.xml");
        this.load.bitmapFont("university", "assets/fonts/university.png", "assets/fonts/university.xml");
